...
suite('RoutesMongoDbPersistence', ()=> {
    let persistence: RoutesMongoDbPersistence;
    let fixture: RoutesPersistenceFixture;

    setup((done) => {
        var MONGO_DB = process.env["MONGO_DB"] || "test";
        var MONGO_COLLECTION = process.env["MONGO_COLLECTION"] || "routes";
        ...
        persistence = new RoutesMongoDbPersistence();
